...
export function Skills() {
  return (
    <Container>
      ...
      <ContainerBottom>
        <p>Essas são as Principais Tecnologias e Ferramentas que me Auxiliam no Desenvolvimento de Aplicações Web. Fora estas, tenho Conhecimento nas Áreas de: Metodologias Ágeis, como Scrum; <a href="https://styled-components.com/" target="_blank" rel="noreferrer">Styled Components</a>; <a href="https://redux.js.org/" target="_blank" rel="noreferrer">Redux</a>; <a href="https://github.com/reduxjs/redux-thunk" target="_blank" rel="noreferrer">Redux Thunk</a>; <a href="https://reactrouter.com/en/main" target="_blank" rel="noreferrer">React Router Dom</a>;</p>
      </ContainerBottom>
    </Container>
  )
}